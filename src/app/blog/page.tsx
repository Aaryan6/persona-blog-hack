      ...
      <main className="max-w-7xl mx-auto">
        ...
        <section className="container mx-auto px-4 pt-28 pb-12 md:pt-36 md:pb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-[#5b6084] mb-8">
              Thoughts, stories, and ideas about design, photography, and
        ...
        <section className="container mx-auto px-4 py-6">
          <div className="flex flex-wrap gap-2 md:gap-3 justify-center">
            <Link href="/blog">
              <CategoryBadge active={!activeTag}>All</CategoryBadge>
            </Link>
          ...
          {filteredPosts.length > 0 && (
            <div className="flex justify-center mt-12">
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
                  className="rounded-full border-[#d9d9d9] hover:border-[#2d3047] hover:bg-white text-[#5b6084] px-6"
                  disabled
                >
                  Previous
                </Button>
